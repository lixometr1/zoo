<template>
  <div class="pb-5.5 border-b border-grey-light">
    <div class="flex">
      ...
      <div class="ml-2">
        <CheckoutDeliveryCitySelect v-model="cityModel" />
      </div>
    </div>
    <div class="flex flex-wrap mt-4">
      <a
        ...
        class="mr-3 text-sm font-medium border-b-2 border-grey border-opacity-50 border-dotted hover:text-green hover:border-green transition-all"
